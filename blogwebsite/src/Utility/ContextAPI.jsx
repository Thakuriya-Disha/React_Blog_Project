...
function ContextAPI(props){
    const [data,setData] = useState([
        ...
        },
        {
            ...
            title:"Girls by aespa  |  8th Jul 2022",
            ...
            article:
            `
            The group's name, Aespa, combines the English initials of "avatar" and "experience" (Avatar X Experience) with the English word "aspect", meaning "two sides", 
            to symbolize the idea of "meeting another self and experiencing the new world". Girls is the second extended play by South Korean girl group Aespa. 
            The EP was released through SM Entertainment and Warner Records on July 8, 2022. It consists of six tracks and was preceded by the promotional single "Illusion", 
            and two official singles: "Life's Too Short" (English version) and "Girls". Girls was a commercial success and debuted at number one on South Korea's Circle Album Chart. 
            Aespa's second number-one album on the chart and their highest-selling album to date. In September, the EP was certified Million by the Korea Music Content Association (KMCA). 
            It also debuted at number three on the Billboard 200 becoming the group's second and highest entry on the chart.
            Girls features various genres such as dance-pop and pop. Lyrically, the album discusses themes of love, self-confidence, friendship, alliance, and more. 
            Rolling Stone's Kristine Kwak noted that while "Girls" and "Illusion" are closer to the group's futuristic sound, the rest of the mini album is "more light-hearted side of the 
            girls with themes of not taking life too seriously". 
            
            The lead single "Girls" was described as a "dark", "brooding" dance, pop and electropop song with "heavy bass synth" and 
            lyrics about "Aespa and ae-Aespa having a full-fledged battle with Black Mamba [the antagonist]". It's "glitchy, electronic-heavy production" softens during the bridge, before 
            "sliding into a nutty techno breakdown" at the end. The second track "Illusion" was described as an electronic "high-energy" hip hop, synth-pop, dance and EDM-trap song with 
            "punchy 808 bass and kicking sound that catches the ears". It consists of elements indicative of hyperpop, including an "eccentric percussion to hi-hats and electric, 
            woodblock-like clicks". Lyrically, the song was described as having "Aespa's own color expressed" such as "comparing the desire to seduce and devour one's opponent to goblin fire". 
            
            The third track "Lingo" was described as a country dance and dance-pop song with a "reverse charm that combines bass and energetic drums", "Wild West-worthy" harmonica. 
            The track celebrates "the special and unique bonds between close friends", expressed through the metaphor of a shared lingo. The fourth track "Life's Too Short" is a medium-tempo pop, 
            soft pop and bubblegum pop song with a "catchy, electric guitar riff" and "bright, breezy and hopeful vocals". The song's lyrics feature a "positive aspiration to enjoy a once-in-a-lifetime life as desired without regrets". 
            The last track "ICU" is a "gentle" and "soothing" acoustic ballad that has a "harmonious" folk guitar and "delicate" strings. 
            It delivers a message that emphasizes the importance of "making sure to take a step back and rest in the midst of busy times".
            `
        },
        {
            category:"music",
            ...
            title:"How To Let Go by Sigrid  |  6th May 2022",
        ...
        },
        {
            ...
            title:"Forever Daze by RADWIMPS  |  23rd Nov 2021",
        ...
        },
        {
            ...
            title:"Red (Taylor's Version) by Taylor Swift  |  12th Nov 2021",
        ...
        },
        {
            ...
            title:"Obsession by EXO  |  27th Nov 2019",
        ...
        },
        {
            ...
            title:"Lover by Taylor Swift  |  23rd Aug 2019",
        ...
        },
        {
            ...
            title:"Cleopatra by The Lumineers  |  8th Apr 2016",
